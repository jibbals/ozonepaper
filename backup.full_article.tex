...
\affil[2]{Australian Antarctic Division}
...
\affil[5]{Jenny's other affiliation}
...
\section{Introduction}
  ...
  %\subsection{Background}
    ...
    %The relative contributions to the tropospheric ozone budget of photochemistry and STT (dynamical transport) is still uncertain \citep{Zanis2003}(TODO: more recent source). 
