...
\section{Southern Ocean extrapolation}
  ...
  \subsection{Outline}
    ...
    Figure \ref{fig:SOExtrapolation} (upper panel) shows the factors I, L, and $\Omega_{SO_{O_3}}$ which are used along with the assumed event lifetime to estimate the STT flux.
