...
\section{Data and Methods}
  ...
  \label{Section:ozonesondes}
    ...
    \begin{figure*}[t]
      ...
      \igtwo{figures/seasonaltropozone}
      \caption{ %
  ...
  \label{Section:BiomassBurning}
    ...
    \begin{figure}[t]
      ...
      \igone{figures/AIRS_compare.png}
      \caption{ %
  ...
  \label{Section:WeatherClassifications}
    ...
    % these IMAGE CREATED BY show_profile.py, EDITTED IN INKSCAPE and then PINTA
      ...
      \igtwo{figures/Melbourne20050203.png}
    ...
    % these IMAGE CREATED BY show_profile.py, EDITTED IN INKSCAPE
      ...
      \igtwo{figures/Melbourne20100113.png}
...
\section{STT event climatologies}
  ...
  % these IMAGE CREATED BY non_transport_summary.py, labels edited IN INKSCAPE
    ...
    \igone{figures/summary_season.png}
  ...
  For both Melbourne and Macquarie Island, the STT events mainly occur in summer, and are associated with low pressure synoptic systems.
  ...
  The polar vortex and associated lowered tropopause may be responsible for the STTs detected in winter.
  ...
  \begin{figure}[t]
    ...
    \igone{figures/AndrewProxySTT.png}
  ...
  \begin{figure}[t]
    ...
    \igone{figures/summary_altitude.png}
  ...
  \begin{figure}[t]
    ...
    \igone{figures/summary_depth.png}
...
\section{Simulation of southern mid-latitude ozone columns}
  ...
  \begin{figure*}[t]
    ...
    \igtwo{figures/StationSeries.png}
  ...
  \begin{figure*}[t]
    ...
    \igtwo{figures/seasonalprofiles00.png}
  ...
  \begin{figure}[t]
    ...
    \igone{figures/event_profile_comparison.png}
    \caption{%
...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  Our estimate provides a very conservative lower bound for how much ozone is transported from the stratosphere.
  ...
  % Flux box and whisker plots from flux_summary.pro in OzoneWork(HPC) and edited in Inkscape
    ...
    \igone{figures/flux_absolute.png}
  ...
  \begin{figure}[t]
    ...
    \igone{figures/flux_relative.png}
  ...
  \begin{figure*}[t]
    ...
    \igtwo{figures/SO_extrapolation.png}
  ...
  If we we assume a fractional ozone flux due to each event STT event of $f$=35\% based on their results (rather than our calculation of 2-4\%), our estimate of the net downward ozone STT flux from southern ocean STT events increases by an order of magnitude to $\sim$29.5~Tg yr$^{-1}$ -- 39\% of the global net downward flux estimated by \citet{Sprenger2003}.
