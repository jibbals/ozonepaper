...
This wide range in model estimates exists in part because STT is challenging to accurately represent in global models, which are not adequately resolved  to simulate small scale turbulence.
