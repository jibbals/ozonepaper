...
%\section{Introduction}
  ...
  Section \ref{sec:ModelComparison} analyses how well GEOS-Chem captures the tropospheric ozone seasonality and quantity near our three sites.
...
\section{Simulation of ozone columns}
...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  \subsection{Comparison to literature}
    ...
    \cite{Roelofs1997} use a model with a stratospheric ozone tracer to estimate STT impacts. 
