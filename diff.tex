...
%DIF ADD OzonePaper.tex                Tue Mar 28 10:44:24 2017
%% ---------------------------------
...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  \DIFdelbegin \DIFdel{We use simulated tropospheric ozone columns from GEOS-Chem to extrapolate the ozonesonde-based estimates to the entire Southern Ocean region , defined here as 35$^{\circ}$ S-75$^{\circ}$ S to encompass our three measurement sites.
...
\DIFdel{) by the monthly mean fraction of the ozone column attributed to STT (as in Fig. \ref{fig:fluxsummary}, }\textit{\DIFdel{I}}%DIFAUXCMD
\DIFdel{) and by the monthly mean tropospheric ozone column over the Southern Ocean (from the GEOS-Chem multi-year mean, $\Omega_{SO_{O_3}}$), expressed simply as Flux$= \Omega_{SO_{O_3}} \times f \times I$.
  The monthly values of each term in this equation }\DIFdelend \DIFaddbegin \DIFadd{TODO: Extrapolate over small region here and mention supplementary extrapolation.
