...
\section{Data and Methods}
  ...
  \label{sec:ozonesondes}
    ...
    % figure produced in seasonal_tropopause in Examine_stations.py
      ...
      \caption{%
	Multi-year monthly median tropopause altitude (minimum of lapse rate and ozone defined tropopause) determined from ozonesondes measurements at Melbourne (2004-2013), Macquarie Island (2004-2013) and Davis (2006-2013) (solid lines).
...
\section{STT event climatologies}
  ...
  The high frequency of STT ozone enhancements is comparable to the $>25\%$ frequencies seen near over the Turkey and east of the Caspian sea in an ERA-I analysis performed by \citet{Tyrlis2014}. 
