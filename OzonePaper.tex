...
\section{STT event climatologies}
  ...
  \begin{figure}[t]
    ...
    \caption{The distribution of STT events altitude at Davis (top), Macquarie Island (middle), and Melbourne (bottom), determined as described in the text.
  ...
  \begin{figure}[t]
    ...
    \caption{The distribution of STT events depth, defined as the distance from the event to the tropopause, at Davis (top), Macquarie Island (middle), and Melbourne (bottom), determined as described in the text.
    Events are coloured as described in Fig. \ref{fig:SummarySeasonality}.}
