...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  \subsection{Method}
	...
	The black line shows STT ozone flux if event lifetime is assumed to be 2 days, with dashed lines showing flux if event lifetime was assumed to be either 1 day or 1 week.}
	...
	Macqaurie   & 20(412\%)  & 9(666\%)  & 5(958\%)  & 4(1267\%) \\
	Melbourne   & 195(223\%) & 18(500\%) & 5(1320\%) & 15(635\%) \\
	\hline
      \end{tabular}
