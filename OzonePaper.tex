...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  \subsection{Results}
    ...
    The regions over Davis, Macquarie Island, and Melbourne have estimated STT ozone contributions of $\sim 3.8 \times 10^{17}$, $\sim 3.7 \times 10^{17}$, and $\sim 7.4 \times 10^{17}$ molecules cm$^{-2}$ a$^{-1}$ respectively, or equivalently $\sim 2.0$, 2.1, and 3.3~Tg a$^{-1}$.
