...
\section{Data and Methods}
  ...
  \label{sec:ozonesondes}
    ...
    % figure produced in seasonal_tropopause in Examine_stations.py
      ...
      \caption{%
	Multi-year monthly median tropopause altitude (using the ozone defined tropopause) determined from ozonesondes measurements at Melbourne (2004-2013), Macquarie Island (2004-2013) and Davis (2006-2013) (solid lines).
