...
%\documentclass[acp, manuscript]{copernicus} % single column manuscript
\documentclass[acp]{copernicus} % two column
%\documentclass[acp]{copernicus_discussions} % discussion stage
...
%TODO: replace these before submitting
...
\runningtitle{Ozone STTs}
\runningauthor{J. Greenslade}
...
Thanks to Dr. M. Tully who gladly shared the ozonesonde data.
%Thanks to Dr. S. Alexander who really got me started on this project.
%Thanks to Dr. Fisher who's comments seem endless and useful
