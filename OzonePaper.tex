...
\section{Data and Methods}
  ...
  \subsection{Characterisation of STT events and associated fluxes}
    ...
    This is done quickly using a fast fourier transform method \citep{Press1992}, using IDL code written by Dr. Simon Alexander shown in a supplementary document (TODO: how to reference?).
...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  TODO: mention supplementary extrapolation. and add plots for subregion extrap (perhaps?)
  ...
  %If we assume the proportion of ozone due to an event is actually 35\%, as in Terao08 for the northern hemisphere: 4.627e+17 molecules/cm2/yr (2.166e+00 Tg/yr)
