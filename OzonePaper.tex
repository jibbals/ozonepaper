...
%\section{Introduction}
  ...
  The EM frequently shows a summer maximum of stratospheric subsidence, which sits between 20$^{\circ}$E and 35$^{\circ}$E and 31$^{\circ}$N to 39$^{\circ}$N, while zonally most subtropical tropopause folds occur during Winter \citep[][and references therein]{Tyrlis2014}.
...
\section{STT event climatologies}
  ...
  The winter maximum does not include Melbourne, or the southern ocean, which explains why we see a seasonality which disagrees with these prior studies.
