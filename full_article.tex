...
\begin{abstract}
  ...
  The primary method we focus on here shows STT events primarily occurring during summer above all three sites, although there are relatively more events seen in the austral winter above Davis.
  ...
  Using an assumed STT impact (of 30\%) over the southern ocean rather than our conservative calculation increases the flux estimate by roughly a factor of 11, to $\sim$21.38~Tg yr$^{-1}$.
