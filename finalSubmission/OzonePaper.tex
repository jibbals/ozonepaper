...
\section{Data and Methods}
  ...
  \label{sec:ozonesondes}
    ...
    % figure produced in seasonal_tropopause in Examine_stations.py
      \includegraphics[width=10cm]{f02.png}
      \caption{%
    ...
    \begin{figure}[t]
      ...
      \includegraphics[width=12.0cm]{f03}
      \caption{ %
  ...
  \subsection{Characterisation of STT events and associated fluxes}
    ...
    \begin{figure}[t]
      ...
      \includegraphics[width=8.3cm]{f04}
      \caption{ %
...
\section{STT event climatologies}
  ...
  \begin{figure}[t]
	...
	% summary_season.png
    \includegraphics[width=12cm]{f05}
  ...
  \begin{figure}[t]
    ...
    % AndrewProxySTTV2.png
    \includegraphics[width=10cm]{f06}
  ...
  \begin{figure}[t]
    ...
    % summary_altitude.png
    \includegraphics[width=12cm]{f07}
  ...
  \begin{figure}[t]
  	% Fig 8
  	% summary_depth.png
    \includegraphics[width=12cm]{f08}
...
\section{Simulated ozone columns}
  ...
  \begin{figure}
    ...
    % StationSeries.png
    \includegraphics[width=12.0cm]{f09}
  ...
  \begin{figure}
    ...
    % seasonalprofiles00.png
    \includegraphics[width=14.0cm]{f10}
    \caption{%
  ...
  \begin{figure}
  	% Fig 11
  	% event_profile_comparison.png
    \includegraphics[width=12cm]{f11}
    \caption{%
...
\section{Stratosphere-to-troposphere ozone flux from STT events}
  ...
  \subsection{Results}
    ...
    \begin{figure}
      ...
      % STT_extrapolation_Dav.png
      \includegraphics[width=12.0cm]{f13}
      \caption{%
    ...
    \begin{figure}
      % Plot from examine_stations.py in stations repo
      % STT_extrapolation_Mac
      \includegraphics[width=12.0cm]{f14}
      \caption{%
    ...
    \begin{figure}
      %
      % STT_extrapolation_Melb.png
      \includegraphics[width=12.0cm]{f15}
      \caption{%
